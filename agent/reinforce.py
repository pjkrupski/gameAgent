...
class Reinforce(tf.keras.Model):
    def __init__(self, state_size, state_size2, num_actions):
        ...
        self.D1 = tf.keras.layers.Conv2D(filters=256, kernel_size=5, strides = (1,1), activation = 'relu', input_shape=[state_size,state_size2,8])
        
        self.D2 = tf.keras.layers.Conv2D(filters=128, kernel_size=5, strides = (1,1), activation = 'relu')
        
        self.D3 = tf.keras.layers.Conv2D(filters=64, kernel_size=5, strides = (1,1), activation = 'relu')
